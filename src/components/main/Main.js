...
const Main = () => {
    return (
        <div>
                ...
                <div class="containerButton"><NavLink to="/chat"><button className="button"> + Nuevo chat con PetronApp</button></NavLink> <NavLink to="/ingredientes"><button className="button">Selector de ingredientes</button></NavLink></div> 
                </div>
        </div>
    )
}
